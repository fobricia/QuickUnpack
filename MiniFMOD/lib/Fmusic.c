...
//	memset(FSOUND_Channel,0,256*sizeof(FSOUND_CHANNEL));
	...
	FSOUND_MixBuffer=(signed char*)(((DWORD_PTR)FSOUND_MixBufferMem+15) & ~0xF);

	// ========================================================================================================
	// PREFILL THE MIXER BUFFER
	// ========================================================================================================

	do FSOUND_Software_Fill();
...

	{
		...
		SetThreadPriority(FSOUND_Software_hThread,THREAD_PRIORITY_TIME_CRITICAL);
	}
	return TRUE;
}
